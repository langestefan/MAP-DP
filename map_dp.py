    ...
    while (abs(dE) > epsilon and ic < maxiter):
        ...
        for i in range(N):
            ...
            for k in range(K):
                ...
                mki, aki, cki, Bki = __nwupd(Nki[k], X[:, zki], m0, a0, c0, B0)

                # Compute Student-t NLL, existing clusters (Alg. 3 line 8)
                dk[k] = __stnll(xi, mki, aki, cki, Bki, D)
...
def __nwupd(Nki, xki, m0, a0, c0, B0):
    '''
